...
window.Routes =
  ...
  operator_product_url:                 (id) -> root_url + '/operator/products/' + id

  products_by_category_url:              (id) -> root_url + '/operator/products?category_id=' + id

unless root_url
  Routes.operator_product_url=                  (id) -> 'modal-edit-product.html'
